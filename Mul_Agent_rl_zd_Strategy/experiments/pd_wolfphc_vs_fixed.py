...
def playOneGame(agentX=agentWolfPHC, agentY=agentFixedStrategy):
    agentX = agentX
    agentY = agentY
...
def calAgentPayoffs(agentX=agentWolfPHC, agentY=agentFixedStrategy):
    agentX = agentX
    agentY = agentY
    actionX = np.random.choice(actions)
    actionY = np.random.choice(actions)
...
def rungame(agentX=agentWolfPHC, agentY=agentFixedStrategy):
    agentX = agentX
    agentY = agentY
