...
file = open("../results/phc_vs_fixedall_0.1.txt")
...
plt.figure()
plt.xlabel('States')
plt.ylabel('Average Cooperative Possibilities')
plt.xticks([1, 2, 3, 4], ['$(C, C)$', '$(C, D)$', '$(D, C)$', '$(D, D)$'])
plt.errorbar([1,2,3,4], [mean0, mean1, mean2, mean3], yerr=[std0, std1, std2, std3], fmt='o', ecolor='g', capthick=2)
plt.show()
