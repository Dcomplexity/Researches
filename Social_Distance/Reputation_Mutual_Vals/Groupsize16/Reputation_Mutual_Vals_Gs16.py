...
if __name__ == "__main__":
    ...
    dirname = abspath + "/Results/Re_Reputation_Mutual_Vals/Re_Groupsize_16/"
    if not os.path.isdir(dirname):
        os.makedirs(dirname)
    filename = dirname + "Re_Co_Rate_Gs_16_Dp_%s_Rt_%s_Rq_%s.txt" %(buildDefectParam, buildRt, buildRq)
    f = open(filename, 'w')
