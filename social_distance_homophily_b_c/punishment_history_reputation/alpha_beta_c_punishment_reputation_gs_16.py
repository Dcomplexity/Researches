...
def run_game(step, ind_rep, ind_strategy, alpha, beta, play_num, defect_param, group_size, group_base, group_length, total_num,
             ind_pos, pos_ind, rt, rq, punishment_cost, gamma):
...
if __name__ == "__main__":
    ...
    file_name = dir_name + 'frac_c_punishment_%s_reputation_gs_%s_d_%s_g_%s.txt' % (punishment_cost_r, group_size_r, defect_param_r, gamma_r)
    f = open(file_name, 'w')
