...
def run_game(ind_strategy, alpha, beta, play_num, defect_param, group_size, group_base, group_length, total_num, ind_pos, pos_ind, punishment_cost):
...
if __name__ == "__main__":
    ...
    dir_name = abs_path + '/results/re_alpha_beta_punishment_cost/'
    if not os.path.isdir(dir_name):
        os.makedirs(dir_name)
    file_name = dir_name + 'frac_co_alpha_beta_c_d_punishment_%s_gs_%s_d_%s.txt' % (punishment_cost_r, group_size_r, defect_param_r)
    f = open(file_name, 'w')
            ...
            for round_index in range(rounds):
                ...
                for i in range(run_time):
                    ind_strategy_r = run_game(ind_strategy_r, alpha_r, beta_r, play_num_r, defect_param_r, group_size_r,
                                              group_base_r, group_length_r, total_num_r, ind_pos_r, pos_ind_r, punishment_cost_r)
                sample_strategy = []
