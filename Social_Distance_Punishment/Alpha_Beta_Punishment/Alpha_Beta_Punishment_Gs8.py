...
def PDGame(strategy0, strategy1, b):
    ...
    if (strategy0 == 1 or strategy0 == 2) and (strategy1 == 1 or strategy1 == 2):
        return (1, 1)
    elif (strategy0 == 1 or strategy0 == 2) and strategy1 == 0:
        return (0, b)
    elif strategy0 == 0 and (strategy1 == 1, strategy1 == 2):
        return (b, 0)
...
if __name__ == "__main__":
    ...
    if not os.path.isdir(dirname):
        os.makedirs(dirname)
    filename = dirname + "Re_Alpha_Beta_Punishement_Gs_8_Dp_%s.txt" %buildDefectParam
    f = open(filename, 'w')
