...
if __name__ == "__main__":
    ...
    agentY = agentFixedStrategy(alpha=alpha, gamma=gammaValue, delta=deltaValue, epsilon=epsilon, fixedStrategy=[1.0, 0.0, 1.0, 0.0])
    ...
    myfile = open('../files/results/phc_vs_tft.txt', 'w')
