...
if __name__ == "__main__":
    ...
    myfile = open('../files/results/phc_vs_fixedall_0.1.txt', 'w')
    for i_0 in np.arange(0, 1.1, 0.1):
        for i_1 in np.arange(0, 1.1, 0.1):
            for i_2 in np.arange(0, 1.1, 0.1):
                for i_3 in np.arange(0, 1.1, 0.1):
