...
from experiments.pd_wolfphc_vs_fixed import *
...
if __name__ == "__main__":
    ...
    agentY = agentFixedStrategy(alpha=alpha, gamma=gammaValue, delta=deltaValue, epsilon=epsilon, fixedStrategy=[11.0/13.0, 1.0/2.0, 7.0/26.0, 0.0])
    ...
    myfile = open('../files/results/wolfphc_vs_zd.txt', 'w')
