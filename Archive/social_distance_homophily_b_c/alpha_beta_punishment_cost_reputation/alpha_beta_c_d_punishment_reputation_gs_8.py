...
if __name__ == "__main__":
    ...
    dir_name = abs_path + '/results/re_alpha_beta_punishment_cost_reputation/'
    if not os.path.isdir(dir_name):
        os.makedirs(dir_name)
    file_name = dir_name + 'frac_co_alpha_beta_c_d_punishment_%s_reputation_gs_%s_d_%s.txt' % (punishment_cost_r, group_size_r, defect_param_r)
    f = open(file_name, 'w')
