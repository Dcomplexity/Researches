...
if __name__ == "__main__":
    ...
    dirname = abspath + "/Results/Re_Tag_Distribution_Model/"
    if not os.path.isdir(dirname):
        os.makedirs(dirname)
    filename = dirname + "Re_Tag_100_power_law_sort_Gs_8_Dp_%s_t_%s.txt" %(buildDefectParam, buildTolerance)
    f = open(filename, 'w')
